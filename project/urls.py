...
from project.apps.venta.views import get_listaprecio
...
urlpatterns = [
                  ...
                  path('admin/venta/clientes/<int:pk_cliente>', get_listaprecio, name='get_listaprecio'),
                  ...
                  path('admin/promocion/promocion/promociones/<int:pk_sucursal>', get_promociones_sucursal,
                       name='get_promociones_sucursal'),
                  path('admin/precio/precio_articulo/<int:id_articulo>', get_precio_articulo, name='precio_articulo'),
                  path('admin/inventario/movimientointerno/<int:numero_lote>', recepcionar_movimiento_ingreso,
                       name='recepcionar_movimiento'),
