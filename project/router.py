...
router.register('sueldo', api_caja.SueldoViewSet, basename='sueldo')
router.register('adelanto', api_caja.AdelantoViewSet, basename='adelanto')
router.register('ingreso', api_caja.IngresoViewSet, basename='ingreso')
router.register('retiroefectivo', api_caja.RetiroEfectivoViewSet, basename='retiroefectivo')
router.register('gasto', api_caja.GastoViewSet, basename='gasto')
router.register('tipoingreso', api_caja.TipoIngresoViewSet, basename='tipoingreso')
router.register('tipogasto', api_caja.TipoGastoViewSet, basename='tipogasto')
